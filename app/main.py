...
# -----------------------------
# Load LLM (CORRECT OpenRouter config)
# -----------------------------

llm = ChatOpenAI(
    model="deepseek/deepseek-chat",  # ✅ MUST include provider
    openai_api_base="https://openrouter.ai/api/v1",  # ✅ correct param
    openai_api_key=OPENROUTER_API_KEY,  # ✅ correct param
    default_headers={
